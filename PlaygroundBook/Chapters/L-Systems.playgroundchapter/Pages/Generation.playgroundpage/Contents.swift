...
//#-end-hidden-code
/*:
 What you just saw is called a dragon curve. A dragon curve is a special kind of **L-System**, which is the topic of this playground. To get started, we'll have a look at how motion can be described using letters.
 ...
 Now go ahead and run the code below. You'll see the arrow perform the motions as described.
 Try to extend the path so our arrow moves along an S-shape.
 When you're ready experimenting and ask yourself how this could be interesting, head over to the [next page](@next).
